                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(labelText: "ID FSEGA:"),
                      ),
                      TextField(
                        readOnly: true,
                        controller: _textControllerPass,
                        decoration: InputDecoration(labelText: "Parola FSEGA:"),
                      ),
                      SizedBox(
                        height: 15.0,
                      ),
                              ...
                              (r) {
                                if (r != rows[0]) {
                                  ...
                                  intervalOrar.disciplina = cols[6]
                                      .innerHtml
                                      .replaceAll(new RegExp(r'<[^>]*>'), '');
                                  final matches2 = exp3.firstMatch(cols[7]
                                      .innerHtml
                                      .replaceAll(new RegExp(r'<[^>]*>'), ''));
                                  ...
                                  Navigator.push(
                                    ...
                                    new MaterialPageRoute(
                                        builder: (context) => new MyMainPage()),
                                  );
                                }
                              },
                            );
